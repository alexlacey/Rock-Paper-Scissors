...
public class RockPaperScissors {
	...
	private static void determineWinner(String userChoice, String compChoice) {
		if (userChoice.equals("Scissors") && compChoice.equals("Paper") || userChoice.equals("Rock") && compChoice.equals("Scissors") || userChoice.equals("Paper") && compChoice.equals("Rock")) {
			System.out.println(userChoice + " beats " + compChoice + " - you win!");
		}
		else if (userChoice.equals("Paper") && compChoice.equals("Scissors") || userChoice.equals("Scissors") && compChoice.equals("Rock") || userChoice.equals("Rock") && compChoice.equals("Paper")) {
